...
const PopularCourseCard = ({ course }) => {
    const { course_name, image, price, enrole_student, rating } = course
    return (
            ...
            <div className="card-body">
                ...
                <div className='flex justify-between items-center my-3 text-lg'>
                    <span className='flex justify-between items-center font-semibold'>
                        ...
                        <span className='ml-4  flex justify-between items-center font-semibold'><PiStudentLight className='mr-2' /> {enrole_student}</span>
                    </span>
                    <span className='font-bold'>${price}</span>
                </div>
                <div className="card-actions mt-2 justify-center ">
                    <button className="btn btn-primary w-4/5">Buy Now</button>
                </div>
            </div>
        </div>
    );
