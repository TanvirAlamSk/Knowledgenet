...
const Comments = () => {
    return (
        <div className="containerr mt-16 mb-36 ">
            ...
            <div className="pic-ctn">
                <div className='card-img  w-32 md:w-60  flex flex-col justify-center'>
                    <img className='w-24 h-24 rounded-full pic' src={commentimg1} alt=""
                    />
                    <MdComment>
                    </MdComment>
                ...
                <div className='card-img  w-32 md:w-60   flex flex-col  justify-center'>
                    <img className='w-24 h-24 rounded-full pic' src={commentimg2} alt="" />
                    <MdComment></MdComment>
                ...
                <div className='card-img  w-32 md:w-60   flex flex-col justify-center'>
                    <img className='w-24 h-24 rounded-full pic' src={commentimg3} alt="" />
                    <MdComment></MdComment>
                    <p>
                        "Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris itae erat "</p>
                </div>
                <div className='card-img  w-32 md:w-60   flex flex-col justify-center'>
                    <img className='w-24 h-24 rounded-full pic' src={commentimg4} alt="" />
                    <MdComment></MdComment>
