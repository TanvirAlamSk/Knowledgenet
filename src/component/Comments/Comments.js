...
const Comments = () => {
    return (
        <div class="containerr mt-16 mb-36">
            ...
            <p className='text-center my-5'>How real people said about KnowledgeNet Online Education.</p>
            <div className="pic-ctn ">
                <div className='card-img w-60 h-80 mx-auto flex flex-col justify-center'>
                    <img className='w-40 h-40 rounded-full' src={commentimg1} alt=""
                        class="pic" />
                    <MdComment>
                    </MdComment>
                ...
                <div className='card-img w-60 h-80 mx-auto flex flex-col  justify-center'>
                    <img className='w-40 h-40 rounded-full' src={commentimg2} alt="" class="pic" />
                    <MdComment></MdComment>
                ...
                <div className='card-img w-60 h-80 mx-auto flex flex-col justify-center'>
                    <img className='w-40 h-40 rounded-full' src={commentimg3} alt="" class="pic" />
                    <MdComment></MdComment>
                    <p>
                        "Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris itae erat "</p>
                </div>
                <div className='card-img w-60 h-80 mx-auto flex flex-col justify-center'>
                    <img className='w-40 h-40 rounded-full' src={commentimg4} alt="" class="pic" />
                    <MdComment></MdComment>
