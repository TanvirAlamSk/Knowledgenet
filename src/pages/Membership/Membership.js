                ...
                <div className="xl:w-1/2 lg:w-7/12 relative w-full lg:mt-0 mt-12 md:px-8" role="list">
                    ...
                    <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg p-8 relative z-30">
                        ...
                        <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">
                            <ul className=''>
                                <li ><FaCheck className='text-orange-500 mr-2'></FaCheck>Upskill 5 to 25 employees</li>
                                <li><FaCheck className='text-orange-500 mr-2'></FaCheck>Unlimited access to 8,500 learning opportunities</li>
                                <li><FaCheck className='text-orange-500 mr-2'></FaCheck>Program setup and launch tools</li>
                            </ul>
                        </p>
                    </div>
                    <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg mt-3 flex relative z-30">
                        ...
                        <div className="w-full p-8">
                            ...
                            <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">
                                <ul>
                                    <li><FaCheck className='text-orange-500 mr-2'></FaCheck>Upskill 5 to 125 employees</li>
                                    <li><FaCheck className='text-orange-500 mr-2'></FaCheck>Unlimited access to 8,500 learning opportunities</li>
                                    <li><FaCheck className='text-orange-500 mr-2'></FaCheck>Program setup and launch tools</li>
                                </ul>
                            </p>
                    ...
                    <div role="listitem" className="bg-white cursor-pointer shadow rounded-lg p-8 relative z-30 mt-7">
                        ...
                        <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">
                            <ul>
                                <li><FaCheck className='text-orange-500 mr-2'></FaCheck>Analytics and benchmarking dashboard</li>
                                <li>
                                    <FaCheck className='text-orange-500 mr-2'></FaCheck>Unlimited access to 8,500 learning opportunities
                                </li>
                                <li><FaCheck className='text-orange-500 mr-2'></FaCheck>Program setup and launch tools</li>
                            </ul>
                        </p>
